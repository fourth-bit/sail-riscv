...
def extern_f128Add : BitVec 3 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_f128Sub : BitVec 3 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_f128Mul : BitVec 3 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_f128Div : BitVec 3 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
...
def extern_f128MulAdd : BitVec 3 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
...
def extern_f128Sqrt : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
...
def extern_f128ToI32 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 32) := λ _ => panic "TODO"
def extern_f128ToUi32 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 32) := λ _ => panic "TODO"
def extern_i32ToF128 : BitVec 3 → BitVec 32 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_ui32ToF128 : BitVec 3 → BitVec 32 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_f128ToI64 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64) := λ _ => panic "TODO"
def extern_f128ToUi64 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64) := λ _ => panic "TODO"
def extern_i64ToF128 : BitVec 3 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_ui64ToF128 : BitVec 3 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
...
def extern_f16ToF128 : BitVec 3 → BitVec 16 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_f32ToF128 : BitVec 3 → BitVec 32 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
...
def extern_f64ToF128 : BitVec 3 → BitVec 64 → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
def extern_f128ToF16 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 16) := λ _ => panic "TODO"
def extern_f128ToF32 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 32) := λ _ => panic "TODO"
def extern_f128ToF64 : BitVec 3 → BitVec 64 → BitVec 64 → (BitVec 5 × BitVec 64) := λ _ => panic "TODO"
...
def extern_f128Lt : BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × Bool) := λ _ => panic "TODO"
def extern_f128Lt_quiet : BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × Bool) := λ _ => panic "TODO"
def extern_f128Le : BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × Bool) := λ _ => panic "TODO"
def extern_f128Le_quiet : BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × Bool) := λ _ => panic "TODO"
def extern_f128Eq : BitVec 64 → BitVec 64 → BitVec 64 → BitVec 64 → (BitVec 5 × Bool) := λ _ => panic "TODO"
...
def extern_f128roundToInt : BitVec 3 → BitVec 64 → BitVec 64 → Bool → (BitVec 5 × BitVec 64 × BitVec 64) := λ _ => panic "TODO"
